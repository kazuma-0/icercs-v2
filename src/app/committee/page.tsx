  ...
  return (
    <div className='container pt-5'>
      ...
      <ul className='text-lg space-y-1 pt-3 '>
        <li>Prof. Anand Paul, Kyungpook National University, South Korea</li>
        <li>Prof. Dr. Pao - Ann, National Chung Cheng University, Taiwan</li>
        <li>Prof. Dr. Ahmed Zobaa, Brunel University, London</li>
        <li>Prof. Dr. Ke-Lin Du, Concordia University, Canada</li>
        <li>Prof. Joao Manuel R.S Tavares, University do Porto, Portugal</li>
        <li>Prof. Dr. Ajay Kumar Jha, North Dakota State University, USA</li>
      ...
      <ul className='text-lg space-y-1 pt-3 '>
        ...
        <li>Prof. Dr. C. Yogesh, Vellore Institute of Technology, Vellore</li>
        <li>
